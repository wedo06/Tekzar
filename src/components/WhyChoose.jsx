...
const WhyChoose = () => {
  ...
  return (
    <section className="section why-section" id="why" ref={sectionRef} aria-labelledby="why-title">
      {/* Background Image Stripe */}
      <div className="why-bg" aria-hidden="true">
        <div className="why-bg-stripe" />
        ...
        <div className="why-layout">
          ...
          <div className="why-left fade-in">
            ...
            <p className="section-subtitle">
              From affordable pricing to pan-India dealer support, TEKZAR is built around
              the real needs of Indian farmers and agricultural professionals.
            </p>
            <div className="why-cta-wrap">
              <a
                href="https://wa.me/917200949459?text=Hi, I want to know more about TEKZAR"
                target="_blank"
            ...
            <div className="why-grid" role="list">
              {whyChoosePoints.map((point, i) => (
                <div
                  ...
                  role="listitem"
                >
                  <div className="why-icon" aria-hidden="true">{point.icon}</div>
                  <div>
                    <h3 className="why-title-card">{point.title}</h3>
